...
import view from './home-decathlon-fr.ts.html'
import style from './home-decathlon-fr.ts.css'
...
@FragmentDynamic
export class HomeDecathlonFr extends FragmentBase
{
    static get is() { return 'teamatical-home-decathlon-fr' }
