...
import view from './home-candjdesignllc.ts.html'
import style from './home-candjdesignllc.ts.css'
...
@FragmentDynamic
export class HomeCandJdesignLLC extends FragmentBase
{
    static get is() { return 'teamatical-home-candjdesignllc' }
