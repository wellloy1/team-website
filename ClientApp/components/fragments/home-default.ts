...
import view from './home-default.ts.html'
import style from './home-default.ts.css'
...
@FragmentDynamic
export class HomeDefault extends FragmentBase
{
    static get is() { return 'teamatical-home-default' }
