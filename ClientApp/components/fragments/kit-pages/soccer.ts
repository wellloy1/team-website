...
import view from './soccer.ts.html'
import style from './soccer.ts.css'
...
@FragmentDynamic
export class SoccerKits extends FragmentBase
{
    static get is() { return 'teamatical-kits-soccer' }
    ...
    _visibleChanged(visible)
    {
        ...
        this.dispatchEvent(new CustomEvent('change-section', { bubbles: true, composed: true, detail: {
            title: this.localize('kits-soccer-title-document'),
        } }))
    }
