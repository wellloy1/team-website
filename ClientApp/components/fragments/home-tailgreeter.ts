...
import view from './home-tailgreeter.ts.html'
import style from './home-tailgreeter.ts.css'
...
@FragmentDynamic
export class Hometailgreeter extends FragmentBase
{
    static get is() { return 'teamatical-home-tailgreeter' }
