...
import view from './home-sportsium.ts.html'
import style from './home-sportsium.ts.css'
...
@FragmentDynamic
export class HomeSportsium extends FragmentBase
{
    static get is() { return 'teamatical-home-sportsium' }
    ...
    static get properties()
    {
        return {
            ...
            homeImagesPath: { type: String, value: 'home-sportsium' },
