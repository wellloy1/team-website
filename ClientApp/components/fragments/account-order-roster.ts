...
import view from './account-order-roster.ts.html'
import style from './account-order-roster.ts.css'
import '../shared-styles/common-styles'
import '../shared-styles/form-styles'
import '../bll/order-roster-data'
import '../ui/ui-button'
import '../ui/ui-loader'
import '../ui/ui-network-warning'
import '../ui/ui-order-item'
import { OrderRosterData } from '../bll/order-roster-data'
...
{
    static get is() { return 'teamatical-account-order-roster' }
    ...
    static get observers()
    {
        return [
            ...
            '_rosterVisibilityChanged(visible, orders.Roster.title)',
        ]
    }
    ...
    get orderlistVirtual(): IronListElement { return this.$['gridList'] }
    get ordersData(): OrderRosterData { return this.$['order-roster-data'] }
    ...
    _rosterVisibilityChanged(visible, rosterTitle)
    {
        if (!visible || !rosterTitle) { return }

        let cat = 'href:' + this.getAttribute('name')
        this.dispatchEvent(new CustomEvent('change-section', {
            bubbles: true, composed: true, detail: {
                category: cat,
                title: this.localize('order-roster-title-document') + ` - ${rosterTitle}`,
            }
        }))
    }
