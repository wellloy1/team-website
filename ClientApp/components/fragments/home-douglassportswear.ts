...
import view from './home-douglassportswear.ts.html'
import style from './home-douglassportswear.ts.css'
...
@FragmentDynamic
export class HomeDouglassportswear extends FragmentBase
{
    static get is() { return 'teamatical-home-douglassportswear' }
