...
import view from './home-lcahl.ts.html'
import style from './home-lcahl.ts.css'
...
@FragmentDynamic
export class HomeLcahl extends FragmentBase
{
    static get is() { return 'teamatical-home-lcahl' }
    ...
    static get properties()
    {
        return {
            ...
            homeImagesPath: { type: String, value: 'home-lcahl' },
