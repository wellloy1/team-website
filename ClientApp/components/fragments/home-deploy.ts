...
import view from './home-deploy.ts.html'
import style from './home-deploy.ts.css'
...
@FragmentDynamic
export class HomeDeploy extends HomeBase
{
    static get is() { return 'teamatical-home-deploy' }
    ...
    connectedCallback()
    {
        ...
        // link.rel = 'stylesheet'
        // link.type = 'text/css'
        // link.href = '/images/home-deploy/font/stylesheet.css'
