...
import view from './home-candgsalesinc.ts.html'
import style from './home-candgsalesinc.ts.css'
...
@FragmentDynamic
export class HomeCandGdesignInc extends FragmentBase
{
    static get is() { return 'teamatical-home-candgsalesinc' }
