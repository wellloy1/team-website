...
//---lit---
import { LocalizeBehaviorBase } from '../bll/localize-behavior-lit'
//---component---
...
export class UIBase extends LocalizeBehaviorBase
{
    ...
    notifyPath(propertyname)
    {
        var detail = { }
        detail[propertyname] = this[propertyname]
        return this.dispatchEvent(new CustomEvent(`${propertyname}-changed`, { detail: detail, bubbles: true, composed: true }))
    }
