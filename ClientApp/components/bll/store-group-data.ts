...
@CustomElement
export class StoreGroupData extends NetBase
{
    static get is() { return 'teamatical-store-group-data' }
    ...
    _computeAPIUrl(api_action, websiteUrl)
    {
        ...
        var url = this.websiteUrl + '/api/v1.0/store/groupshipping-participant-list-' + api_action
        return url
    }
    ...
    _onRequestResponse(e)
    {
        ...
        if (this.api_action == 'makedefault' || this.api_action == 'archive' || this.api_action == 'unarchive')
        {
            ...
            updatedModel = this._cloneModel(this.participants)
        ...
        //save data
        this.set('participantsCache.' + updatedModel.GroupShippingID, updatedModel)
    }
