...
@CustomElement
export class PurchaseInvoiceData extends NetBase
{
    static get is() { return 'teamatical-purchase-invoice-data' }
    ...
    _computeAPIUrl(api_action, websiteUrl)
    {
        ...
        var url = this.websiteUrl + '/api/v1.0/user/purchase-invoice-' + api_action
        return url
    }
    ...
    _convertJson2Class(res, update?)
    {
        ...
        // slist.IsUnderConstruction = true
        // slist.items = []
