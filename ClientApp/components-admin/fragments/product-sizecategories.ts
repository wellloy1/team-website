...
import view from './product-sizecategories.ts.html'
import style from './product-sizecategories.ts.css'
...
@FragmentDynamic
export class AdminProductSizecategories extends FragmentBase
{
    static get is() { return 'tmladmin-product-sizecategories' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/sizecategory/' },
    ...
    newSizeCategoryTap(e)
    {
        // var item = e.model.__data.item
        var url = this._urlViewSizeCategory('_new_')
        this._goto(url)
