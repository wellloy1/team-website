...
import view from './currency-regions.ts.html'
import style from './currency-regions.ts.css'
...
@FragmentDynamic
export class AdminCurrencyRegions extends FragmentBase
{
    static get is() { return 'tmladmin-currency-regions' }
    ...
    newCurrencyRegionTap(e)
    {
        var url = this._urlViewCurrencyRegion('_new_')
        this._goto(url)
