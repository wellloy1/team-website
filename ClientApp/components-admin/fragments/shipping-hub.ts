...
import view from './shipping-hub.ts.html'
import style from './shipping-hub.ts.css'
...
@FragmentDynamic
class AdminShippingHub extends FragmentBase
{
    static get is() { return 'tmladmin-shipping-hub' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/shippinghub/hub-' },
            api_action: { type: String, value: 'get' },
            api_url: { type: String, computed: '_computeAPIUrl(websiteUrl, APIPath, api_action)' },
            queryParamsRequired: { type: Object, value: ['hubid'] }, 
    ...
    _log(v) { console.log(AdminShippingHub.is, v) }
    ...
    addAllCountriesTap(e)
    {
        this.set('order.SupportedCountries', Object.assign([], this.order.AvailableCountries))
    }
    ...
    _orderLoaded(order)
    {
        ...
        // if (!order?.SupportedCountries)
        // {
        //     this.set('order.SupportedCountries', [])
        // }
    }
