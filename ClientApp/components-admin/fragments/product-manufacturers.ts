...
import view from './product-manufacturers.ts.html'
import style from './product-manufacturers.ts.css'
...
@FragmentDynamic
export class AdminProductManufacturers extends FragmentBase
{
    static get is() { return 'tmladmin-product-manufacturers' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/productmanufacturer/' },
    ...
    createNewProductTap(e)
    {
        var url = this._urlViewProductManufacturer('_new_')
        this._goto(url)
    ...
    _variants(itemVariants)
    {
        ...
        return StringUtil.formatSizes(itemVariants)
    }
