...
import view from './shipping-hubs.ts.html'
import style from './shipping-hubs.ts.css'
...
@FragmentDynamic
export class AdminShippingHubs extends FragmentBase
{
    static get is() { return 'tmladmin-shipping-hubs' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/shippinghub/' },
    ...
    newShippingHubTap(e)
    {
        var url = this._urlViewShippingHub('_new_')
        this._goto(url)
