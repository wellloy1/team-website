...
@FragmentDynamic
export class AdminCustomDesignRequests extends FragmentBase
{
    static get is() { return 'tmladmin-custom-design-requests' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/customdesignrequest/' },
