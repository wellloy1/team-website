...
import view from './brands.ts.html'
import style from './brands.ts.css'
...
@FragmentDynamic
export class AdminManufacturerBrands extends FragmentBase
{
    static get is() { return 'tmladmin-manufacturer-brands' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/brand/manufacturer-' },
            ...
            isManufacturer: { type: Boolean, value: true },
        }
    }
    ...
    newBrandTap(e)
    {
        var url = this._urlViewBrand('_new_')
        this._goto(url)
    ...
    _urlViewBrand(brandid, clonebrandid?)
    {
        ...
        return StringUtil.urlquery('/admin/manufacturer-brand', qpars)
    }
