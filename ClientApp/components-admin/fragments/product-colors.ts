...
import view from './product-colors.ts.html'
import style from './product-colors.ts.css'
...
@FragmentDynamic
export class AdminProductColors extends FragmentBase
{
    static get is() { return 'tmladmin-product-colors' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/color/' },
    ...
    newColorTap(e)
    {
        ...
        var url = this._urlViewColor('_new_')
        this._goto(url)
