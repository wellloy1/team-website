...
import view from './product-threads.ts.html'
import style from './product-threads.ts.css'
...
@FragmentDynamic
export class AdminProductThreads extends FragmentBase
{
    static get is() { return 'tmladmin-product-threads' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/productthread/' },
    ...
    newProductThreadTap(e)
    {
        var url = this._urlViewProductThread('_new_')
        this._goto(url)
