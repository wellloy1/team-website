...
import view from './shipping-containers.ts.html'
import style from './shipping-containers.ts.css'
...
@FragmentDynamic
export class AdminShippingContainers extends FragmentBase
{
    static get is() { return 'tmladmin-shipping-containers' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/shippingcontainer/' },
