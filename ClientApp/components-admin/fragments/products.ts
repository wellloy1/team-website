...
import view from './products.ts.html'
import style from './products.ts.css'
...
@FragmentDynamic
export class AdminProducts extends FragmentBase
{
    static get is() { return 'tmladmin-products' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/product/' },
    ...
    newProductTap(e)
    {
        ...
        var url = this._urlViewProduct('_new_')
        this._goto(url)
