...
import view from './nesting-requests.ts.html'
import style from './nesting-requests.ts.css'
...
@FragmentDynamic
export class AdminNestingRequests extends FragmentBase
{
    static get is() { return 'tmladmin-nesting-requests' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/nestingrequest/' },
