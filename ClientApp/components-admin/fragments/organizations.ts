...
import view from './organizations.ts.html'
import style from './organizations.ts.css'
...
@FragmentDynamic
export class AdminOrganizations extends FragmentBase
{
    static get is() { return 'tmladmin-organizations' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/organization/' },
    ...
    createNewOrgConfirmTap(e)
    {   
        this._openDlg(this.$.dialogconfirm as PaperDialogElement)//, (this.smallScreen ? this.shadowRoot.querySelector('div') : e.target)
    }

    createNewOrgTap(e)
    {
        var url = this._urlViewOrganization('_new_')
        this._goto(url)

        // _urlViewOrganization(item.OrganizationID)
        // var url = this.websiteUrl + this.APIPath + 'create'
