...
import view from './workstation-sizelabel.ts.html'
import style from './workstation-sizelabel.ts.css'
...
@WorkstationDynamic
class AdminWorkstationSizelabel extends WorkstationBase
{
    static get is() { return 'tmladmin-workstation-sizelabel' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/workstation/size-label-' },
