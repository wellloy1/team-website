...
import view from './product-configs.ts.html'
import style from './product-configs.ts.css'
...
@FragmentDynamic
export class AdminProductConfigurations extends FragmentBase
{
    static get is() { return 'tmladmin-product-configs' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/productconfiguration/' },
