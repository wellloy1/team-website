...
import view from './shipping-freights.ts.html'
import style from './shipping-freights.ts.css'
...
@FragmentDynamic
export class AdminShippingFreights extends FragmentBase
{
    static get is() { return 'tmladmin-shipping-freights' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/shippingfreight/' },
