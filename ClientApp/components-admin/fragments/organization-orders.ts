...
@FragmentDynamic
export class AdminOrganizationOrders extends FragmentBase
{
    static get is() { return 'tmladmin-organization-orders' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/order/partner-' },
    ...
    {
        if (!orderid) { return '' }
        return '/admin/organization-order?orderid=' + encodeURI(orderid)
    }
