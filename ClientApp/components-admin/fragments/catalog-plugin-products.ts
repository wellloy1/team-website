...
import view from './catalog-plugin-products.ts.html'
import style from './catalog-plugin-products.ts.css'
import style_shared from './shared-styles.css'
import '../../components/ui/ui-sortable-list'
import '../ui/catalog-plugin-products-item'
...
@FragmentDynamic
class AdminCatalogPluginProducts extends FragmentBase
{
    static get is() { return 'tmladmin-catalog-plugin-products' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/catalogplugin/' },
    ...
    static get observers()
    {
        return [
            ...
            // '_log(order.Entries.2.notvalid.Category)'
        ]
    }
    ...
    connectedCallback()
    {
        ...
        this.addEventListener('api-admin-catalog-plugin-item-delete', (e) => this._onListItemDelete(e))
        this.addEventListener('api-admin-catalog-plugin-item-new', (e) => this._onListItemAddBefore(e))
    ...
    hideSyncBtn(env, order)
    {
        return false //env == 'Production'
    }
