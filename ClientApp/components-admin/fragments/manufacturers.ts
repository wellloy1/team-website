...
import view from './manufacturers.ts.html'
import style from './manufacturers.ts.css'
...
@FragmentDynamic
export class AdminManufacturers extends FragmentBase
{
    static get is() { return 'tmladmin-manufacturers' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/manufacturer/' },
