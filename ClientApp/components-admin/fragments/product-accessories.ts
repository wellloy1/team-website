...
import view from './product-accessories.ts.html'
import style from './product-accessories.ts.css'
...
@FragmentDynamic
export class AdminProductAccessories extends FragmentBase
{
    static get is() { return 'tmladmin-product-accessories' }
    ...
    static get properties()
    {
        return {
            ...
            APIPath: { type: String, value: '/admin/api/productaccessory/' },
    ...
    newProductAccessoryTap(e)
    {
        var url = this._urlViewProductAccessory('_new_')
        this._goto(url)
