...
import view from './deal-profiles.ts.html'
import style from './deal-profiles.ts.css'
...
@FragmentDynamic
export class AdminDealProfiles extends FragmentBase
{
    static get is() { return 'tmladmin-deal-profiles' }
    ...
    newDealProfileTap(e)
    {
        var url = this._urlViewDealProfile('_new_')
        this._goto(url)
