...
import view from './ui-task-list.ts.html'
import style from './ui-task-list.ts.css'
...
@CustomElement
export class UIAdminTaskList extends UIBase
{
    static get is() { return 'tmladmin-ui-task-list' }
    ...
    static get properties()
    {
        return {
            ...
            title: { type: String, reflectToAttribute: true, value: "Tasks" },
