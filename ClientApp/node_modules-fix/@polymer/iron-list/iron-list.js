...
`,
  ...
  properties: {
    ...
    //additional fields
    suppressFocus: {type: Boolean, value: false},
  ...
  _itemsChanged: function(change) {
    if (change.path === 'items') {
      ...
      if (this._scrollTop > this._scrollOffset && this._virtualCount < this._virtualCountWas) {
        this._resetScrollPosition(0);
      }
      this._virtualCountWas = this._virtualCount
  ...
  _didFocus: function(e) {
    ...
    if (focusedModel === targetModel) {
      ...
      // visible.
      if (!this._isIndexVisible(fidx) && !this.suppressFocus) {
